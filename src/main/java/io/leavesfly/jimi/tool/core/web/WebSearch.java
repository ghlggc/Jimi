package io.leavesfly.jimi.tool.core.web;

import com.fasterxml.jackson.annotation.JsonPropertyDescription;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.leavesfly.jimi.config.JimiConfig;
import io.leavesfly.jimi.config.info.WebSearchConfig;
...
public class WebSearch extends AbstractTool<WebSearch.Params> {
     ...
     */
    @Autowired
    public WebSearch(JimiConfig jimiConfig, ObjectMapper objectMapper) {
        this(jimiConfig.getWebSearch(), objectMapper);
    }
